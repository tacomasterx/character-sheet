...
import postCharacter from '../../data/add-character.js';
...
function CharacterEquipmentForm(props) {
  ...
  const addNewCharacter = (values) => {
    ...
    newCharacter.equipment = values;
    props.setNewChar(newCharacter);
    postCharacter(props.newChar);
  ...
  return (
    <>
      <h2 className="form-title">Initial equipment</h2>
      <Formik initialValues={
        props.newChar.equipment
        // {
        //   weapons: [],
        //   armor: '',
        //   shield: '',
